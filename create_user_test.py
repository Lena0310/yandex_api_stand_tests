...
def test_create_user_special_symbols_in_first_name_get_error_response():
    negative_assert_symbol("№%@")

def test_create_user_numeric_symbols_in_first_name_get_error_response():
...
def test_create_user_no_first_name_get_error_response():
    user_body = get_user_body(None)
    del user_body["firstName"]
    negative_assert_no_first_name(user_body)

def test_create_user_empty_string_in_first_name_get_error_response():
